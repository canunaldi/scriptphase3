...
def pdfcreatefornew(request):
    ...
    print(date)
    choiceembed1 = request.GET.get('embed1', None)
    ...
    print(choice1pos)
    choiceembed2 = request.GET.get('embed2', None)
    ...
    print(choice2pos)
    choiceembed3 = request.GET.get('embed3', None)
    ...
    print(choice3pos)
    choiceembed4 = request.GET.get('embed4', None)
